...
public class MyQuadView2 extends FrameLayout {
    ...
    public MyQuadView2(Context context) {
        super(context);
        initView();
    }

    public MyQuadView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public MyQuadView2(Context context, AttributeSet attrs, int defStyle) {
